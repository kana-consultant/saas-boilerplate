...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/chdj76m79c3lbwdn6bflwlqa2n2igx02-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/l4nk4g4js5mp6k81sd0y7d00r2w9rar4-devenv-profile" ]
then
  ln -snf /nix/store/l4nk4g4js5mp6k81sd0y7d00r2w9rar4-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
OBJDUMP='objdump'
export OBJDUMP
prefix='/nix/store/38y7z1xdmcdasxlcym8w4bgg8k94w6xk-devenv-shell-env'
...
PGPORT='5432'
export PGPORT
out='/nix/store/38y7z1xdmcdasxlcym8w4bgg8k94w6xk-devenv-shell-env'
export out
...
NIX_STORE='/nix/store'
export NIX_STORE
DEVENV_TASK_FILE='/nix/store/rznykq4qbvdja36lfvqim521p4xc1bip-tasks.json'
...
DEVENV_PROFILE='/nix/store/l4nk4g4js5mp6k81sd0y7d00r2w9rar4-devenv-profile'
export DEVENV_PROFILE
depsBuildTarget=''
export depsBuildTarget
NIX_BINTOOLS='/nix/store/qkqww6ccw4n4px5jzs1fkcg9yh1jnbxl-cctools-binutils-darwin-wrapper-1010.6'
export NIX_BINTOOLS
nativeBuildInputs='/nix/store/c8kngjch0m8mwdqcwv2zv7yz67aw5z4k-bash-interactive-5.3p9-dev /nix/store/8za6hl4pjrsdls8zpk1kyxwvxvzrljj5-postgresql-16.13-dev /nix/store/9xami28xjjswr5rl8sgzwpkjyb7msbx1-start-postgres /nix/store/wdx9p4gghi0sls24f5hn8145cpzjqj43-nodejs-22.22.1 /nix/store/sf4fch0bhjiw2y7kkdk9g9r39zijy7ar-corepack-enable /nix/store/2yh9w0akj40xp3jlp9wbj2vqagim8bgz-typescript-language-server-5.1.3 /nix/store/wdx9p4gghi0sls24f5hn8145cpzjqj43-nodejs-22.22.1 /nix/store/5fg1ygbgp1wdnvh98pbgb2472nr938aa-corepack-nodejs-22.22.1 /nix/store/s854fasrcpcj8x7bc0hnh9wpjgfcbwvh-pkg-config-wrapper-0.29.2'
...
exec /var/folders/z9/4z2tcq690tx2bzsnt67960y00000gn/T/devenv-envlFlIyG/script 